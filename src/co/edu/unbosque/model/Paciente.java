...
public class Paciente {
	...
	public Paciente(int codigo, String nombreape, String rem, String Donderemitido, String diag, String gene,
			String fechaingreso, String medicotratante) {
	...
	public String toString() {
		return "Paciente [CodigoUnico=" + CodigoUnico + ", NombreApellidos=" + NombreApellidos + ", Remitido="
				+ Remitido + ", Donderemitido=" + Donderemitido + ", Diagnostico=" + Diagnostico + ", Genero=" + Genero
